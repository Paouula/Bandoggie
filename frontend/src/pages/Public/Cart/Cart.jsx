...
const ShoppingCartApp = ({ onClose }) => {
    ...
    try {
      ...
      const normalizedCart = parsedCart.map((item, index) => {
        ...
        const normalizedItem = {
          ...
          image:
            item.image || (item.productInfo && item.productInfo.image) || null,
  ...
  useEffect(() => {
    console.log(
      "👀 Componente montado/actualizado, forzando recarga del carrito..."
    );
    loadCartFromStorage();
  ...
  const createOrderInBackend = async (orderData) => {
    try {
      ...
      const orderPayload = {
        ...
        addressClient: `${orderData.customerInfo.direccion}, ${
          orderData.customerInfo.region
        }, ${orderData.customerInfo.departamento}. Tel: ${
          orderData.customerInfo.telefono
        }${
          orderData.customerInfo.referencia
            ? ". Ref: " + orderData.customerInfo.referencia
            : ""
        }`,
      ...
      const response = await fetch(
        "https://bandoggie-production.up.railway.app/api/orders/guest",
        {
          method: "POST",
          headers: {
    ...
    try {
      ...
      if (paymentMethod === "transferencia") {
        try {
          ...
          toast.warning(
            "Pedido creado, pero hubo un problema enviando el email. Contacta soporte."
          );
        }
      }
      ...
      setError(
        error.message || "Error al procesar la compra. Inténtalo de nuevo."
      );
      ...
      {cartItems.map((item) => (
        <div key={item._id || item.id} className="cart-summary-item">
          ...
          <div className="cart-summary-details">
            ...
            {item.talla && (
              <div className="cart-summary-specs">Talla: {item.talla}</div>
            )}
            {item.color && (
              <div className="cart-summary-specs">Color: {item.color}</div>
            )}
            {item.petName && (
              <div className="cart-summary-specs">Mascota: {item.petName}</div>
            )}
      ...
      <div className="cart-container">
        <div className="cart-scroll-content">
          ...
          >
            ...
            ></div>
            <p style={{ color: "#666" }}>Cargando tus productos...</p>
          </div>
        </div>
        <style jsx>{`
          @keyframes spin {
          ...
          <div className="cart-payment-content">
            ...
            <div className="cart-bandoggie-logo">
              ...
              <div className="cart-logo-text">
                ...
                <div className="cart-logo-tagline">
                  Cuidamos a tu mejor amigo
                </div>
              </div>
            </div>

            <h3 className="cart-confirmation-title">
            ...
            {paymentMethod === "transferencia" ? (
              <div className="cart-final-text">
                <p>
                  Hemos enviado los datos bancarios a tu correo electrónico{" "}
                  <strong>{formData.email}</strong>.
                </p>
                <p>
                  Una vez realices la transferencia, nos comunicaremos contigo
              ...
              <div className="cart-summary-card">
                <div className="cart-summary-content">
                  <div className="cart-summary-row">
                    ...
                    <span className="cart-summary-orange-value">
                  ...
                  {guestId && (
                    ...
                    >
                      <div style={{ fontSize: "12px", color: "#666" }}>
                        Referencia: {guestId.slice(-8).toUpperCase()} | Items:{" "}
                        {getCartItemsCount()}
                      </div>
                    </div>
                  )}
          ...
          <div className="cart-checkout-container">
            <div className="cart-checkout-form">
              <div className="cart-guest-form">
                ...
                />
                {errors.email && (
                  <div className="cart-error-message">{errors.email}</div>
                )}
                ...
                <div className="cart-name-row">
                  <div className="cart-name-field">
                    ...
                    <input
                      className={`cart-text-input ${
                        errors.nombre ? "cart-input-error" : ""
                      }`}
                      type="text"
                    ...
                    />
                    {errors.nombre && (
                      <div className="cart-error-message">{errors.nombre}</div>
                    )}
                  </div>
                  <div className="cart-name-field">
                    ...
                    <input
                      className={`cart-text-input ${
                        errors.apellido ? "cart-input-error" : ""
                      }`}
                      type="text"
                ...
                <div className="cart-login-prompt">
                  <span className="cart-login-prompt-text">
            ...
            <div className="cart-delivery-form">
              ...
              <div className="cart-select-row">
                <div className="cart-select-field">
                  ...
                  <select
                    className={`cart-select-input ${
                      errors.departamento ? "cart-input-error" : ""
                    }`}
                ...
                <div className="cart-select-field">
                  ...
                  <select
                    className={`cart-select-input ${
                      errors.region ? "cart-input-error" : ""
                    }`}
                  ...
                  {errors.region && (
                    <div className="cart-error-message">{errors.region}</div>
                  )}
                </div>
              </div>
              ...
              <input
                className={`cart-text-input ${
                  errors.direccion ? "cart-input-error" : ""
                }`}
                type="text"
              ...
              />
              {errors.direccion && (
                <div className="cart-error-message">{errors.direccion}</div>
              )}
              ...
              <div className="cart-name-row">
                ...
                <div className="cart-name-field">
                  ...
                  />
                  {errors.apellido && (
                    <div className="cart-error-message">{errors.apellido}</div>
                  )}
                </div>
              </div>
              ...
              <input
                className={`cart-text-input ${
                  errors.telefono ? "cart-input-error" : ""
                }`}
                type="tel"
              ...
              />
              {errors.telefono && (
                <div className="cart-error-message">{errors.telefono}</div>
              )}
              <small
                style={{
                  color: "#666",
              ...
              <div className="cart-note-container">
                <div className="cart-note-text">
                  <span className="cart-note-bold">NOTA:</span> Las entregas son
                  realizadas por encomiendas, nos comunicaremos contigo sobre
            ...
            <div className="cart-payment-form">
              <div className="cart-payment-toggle">
                  ...
                  style={{
                    backgroundColor:
                      paymentMethod === "transferencia"
                        ...
                        : "transparent",
                    color:
                      paymentMethod === "transferencia" ? "#4a90a4" : "white",
                  }}
                ...
                <button
                  ...
                  style={{
                    backgroundColor:
                      paymentMethod === "efectivo" ? "white" : "transparent",
              ...
              {paymentMethod === "transferencia" ? (
                <div className="cart-payment-content">
                  ...
                  <p className="cart-confirmation-text">
                    ¿Estás seguro de que deseas continuar con tu compra? Te
                    enviaremos a tu correo los datos para realizar la
                    transferencia. ¿Quieres continuar?
                  </p>
                  <button
                    className="cart-continue-button"
                    onClick={nextStep}
                ...
                <div className="cart-payment-content">
                  <p className="cart-efectivo-text">
                    ¡Gracias por tu compra! El pago se realizará en efectivo al
                    momento de la entrega de tu producto.
                  </p>
                  <button
                    className="cart-continue-button"
                    onClick={nextStep}
